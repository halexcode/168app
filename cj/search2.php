				...
				<div class="table-responsive">
				   <table class="table">
				      ...
				      <?php 
				      	if ($res) {
				      		//var_dump($res);
				      		echo '<tr><td><b>考场：</b></td><td>'.$res[0].'</td><td><b>姓名：</b></td><td>'.$res[1].'</td></tr>';
				      		...
				      		echo '<tr><td><b>总分：</b></td><td>'.$res[13].'</td><td><b>校排名：</b></td><td>'.$res[14].'</td></tr>';
				      		echo '<tr><td><b>班排名：</b></td><td>'.$res[15].'</td><td></td><td>'.'</td></tr>';
				      	} else {
