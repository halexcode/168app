...
<div class="container">
  	<div class="row">
  		<div class="col-md-10">
  			<form action="/web/168/index.php/Home/My/re_upass/id/<?php echo session('uid'); ?>" method="post" role="form" class="upassform">
  				<div class="form-group">
				      <label for="oldpass">原密码：</label>
				      <input type="password" class="form-control" name="oldpass" id="oldpass" title='原始密码' placeholder="请输入您的原始密码"datatype="*2-15" ajaxurl="/web/168/index.php/Home/My/ck_upass/uname/<?php echo session('username'); ?>" sucmsg="输入正确！" nullmsg="请输入原始密码！" errormsg="请输入2-15位密码！">
				</div>
				<div class="form-group">
