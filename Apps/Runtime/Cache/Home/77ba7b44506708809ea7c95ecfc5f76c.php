...
<b class="red">暂不开放家长注册！</b><br>
		<form action="/web/168/index.php/Home/Outline/do_reg"method="post" id="form"role="form"class="registerform">
				<div class="form-group">
			      <label for="nickname">昵称：</label>
			      <input type="text" class="form-control" name="nickname" id="nickname" title='昵称' placeholder="请填写登录昵称"datatype="s2-10" ajaxurl="/web/168/index.php/Home/Outline/ck_nickname"  sucmsg="输入正确！" nullmsg="不能为空！" errormsg="请输入2-10字符！">
			   </div>
			   <div class="form-group">
