		...
		<table class="table"id="ta">
		  ...
		  <tbody>
		    <tr>
		      ...
		      <td><a href="/web/168/index.php/Home/Index/weiclass.html" class="btn btn-info a" >168<br>微课堂</a></td>
		    </tr>
		    <tr>
		      <td class="b"><a href="<?php echo U('Outline/search');?>" class="btn btn-success a" >纪律<br>查询</a></td>
		      <td><a href="<?php echo U('Outline/index');?>" class="btn btn-danger a" >纪律<br>登记</a></td>
		    </tr>
		    <tr>
		      <td class="b"><a href="#" class="btn btn-warning a" >班级<br>管理</a></td>
		      <td><a href="/web/168/cj/search167.html" class="btn btn-primary  a" >167<br>查询</a></td>
		    </tr>
		  </tbody>
		</table>
